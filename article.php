...
if($type=="image/jpg" || $type=='image/jpeg' || $type=='image/png')
 ...
 if(!isset($errorMsg))
 {
 $insert_stmt=$db->prepare('INSERT INTO article(designation,image,prix,prixB,stock,description,categorie,site) 
 VALUES(:designation,:image,:prix,:prixB,:stock,:description,:categorie,:site)');
...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">Ajouter un article</span></h2>
        </div>
...
?>
        <form method="post" enctype="multipart/form-data"  >
                        <div class="control-group">
                            <input name="designation" type="text" class="form-control" id="name" placeholder="Désignation"
                        ...
                        <div class="control-group">
                            <input name="prix" type="text" class="form-control" id="name" placeholder="Prix"
                                required="required" data-validation-required-message="Entrer le prix!" />
                            <p class="help-block text-danger"></p>
                        </div>
                      
                        <div class="control-group">
                            <input name="prixB" type="text" class="form-control" id="name" placeholder="Prix barré"
                                required="required" data-validation-required-message="Entrer le prix baré!" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input name="stock" type="text" class="form-control" id="name" placeholder="stock disponible"
