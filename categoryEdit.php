...
$id = $_GET['id'];
require_once "actions/selectCategory.php";
...
if (isset($_POST['submit'])) {
    ...
    $db-> query("UPDATE `categorie` SET `categorie`='$categorie', `description`='$description' WHERE id=$id");
...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">Editer catégorie</span></h2>
        </div>
...
?>     
        <form method="post"  >
                        <div class="control-group">
                            <input value="<?=$category[1]?>" name="categorie" type="text" class="form-control" id="name" placeholder="Catégorie"
                        ...
                        <div class="control-group">
                            <textarea class="form-control" rows="6" id="message" placeholder="Description"
                                ...
                                data-validation-required-message="Entrer une description!"><?=$category[2]?></textarea>
                            <p class="help-block text-danger"></p>
                        </div>
                        <div>
